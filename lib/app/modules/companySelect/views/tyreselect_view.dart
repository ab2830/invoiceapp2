...
class CompanySelecation extends GetView<TyreselectController> {
  ...
  Widget build(BuildContext context) {
    ...
    con.firstLoad();
    return GetBuilder<TyreselectController>(
        builder: (context) {
          return Scaffold(
            appBar: AppBar(
              elevation: 0,
            ...
            body:  Column(
              children: [
                ...
                Expanded(
                  child:
                tyreselectController.tyreListData.isEmpty && tyreselectController.searchController.text.isNotEmpty?
                        ...
                        Card(
                          ...
                          child: GestureDetector(
                            onTap: (){
                              ...
                              con.tyerCompanyController.text=controller.tyreListData[index].title.toString();
