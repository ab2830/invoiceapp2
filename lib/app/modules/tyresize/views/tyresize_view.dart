...
class TyresizeView extends GetView<TyresizeController> {
  ...
  Widget build(BuildContext context) {
    ...
    con.firstLoad();
    return GetBuilder<TyresizeController>(builder: (context) {
      return Scaffold(
        appBar: AppBar(
          elevation: 0,
        ...
        body: Column(
          children: [
            ...
            // ),
            Expanded(
              child: tyresizeController.tyreListData.isEmpty &&
                      tyresizeController.searchController.text.isNotEmpty
                        ...
                        itemBuilder: (_, index) => Card(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              ...
                              if(edit.isTyreSizeEdit==false){
                                con.tyre_SizeId =
                                    controller.tyreListData[index].tyreTypeId;
                                con.tyreSizeController.text = controller
                                    .tyreListData[index].title
                                    .toString();
                                con.update();
                                Get.back();
                              }else{
                                edit.tyre_SizeId =
                                    controller.tyreListData[index].tyreTypeId;
                                edit.tyreSizeController.text = controller
                                    .tyreListData[index].title
                                    .toString();
                                edit.update();
                                Get.back();
                            ...
                            child: ListTile(
                              title: Text(
                                  controller.tyreListData[index].title
                                      .toString(),
                                  style: GoogleFonts.dmSans(
                                      fontWeight: FontWeight.w700,
                                      fontSize: 16.sp,
