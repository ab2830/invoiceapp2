...
class FillterdashboardView extends GetView<FillterdashboardController> {
  var data = Get.put(FillterdashboardController());
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<FillterdashboardController>(
                        ...
                        children: [
                          ...
                          Container(
                            child: CustomButton(
                              ...
                              onPressed: () {
                                controller.getFilterDashBoardData();
                              },
                              title: "Submit",
                          ...
                          Text( controller.dashboardStats?.totalInvoice !=null?
                          controller.dashboardStats?.totalInvoice!.toString() ?? '':'0'.toString(),
                            style: GoogleFonts.dmSans(
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        Text( controller.dashboardStats?.totalRevenue !=null?
                        controller.dashboardStats?.totalRevenue!.toString() ?? '':'0'.toString(),
                          style: GoogleFonts.dmSans(
                              fontWeight: FontWeight.w400, fontSize: 48.sp),
                        ),
                        SizedBox(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        controller.dashboardStats?.tyreRevenue!.toString() ?? '':'0'.toString(),
                          style: GoogleFonts.dmSans(
                              fontWeight: FontWeight.w400, fontSize: 48.sp),
                        ),
                        SizedBox(
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        Text( controller.dashboardStats?.replaceTyreRevenue !=null?
                        controller.dashboardStats?.replaceTyreRevenue!.toString() ?? '':'0'.toString(),
                          style: GoogleFonts.dmSans(
                              fontWeight: FontWeight.w400, fontSize: 48.sp),
                        ),
                        SizedBox(
